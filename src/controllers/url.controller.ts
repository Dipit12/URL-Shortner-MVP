...
// ======================
export const generateShortenedURL = async (req: Request, res: Response) => {
...
// ======================
export const routeToLongURL = async (req: Request, res: Response) => {
    ...
    try {
      ...
      if (urlDoc) {
        ...
        await URLModel.updateOne(
          { shortenURL },
          { $push: { timeStamps: { timeStamps: new Date() } } }
        );
